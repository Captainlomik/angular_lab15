...
export class Http {
    ...
    constructor(public http: HttpClient) { } //отправка запросов на сервер

    private getUrl(url: string = ''): string //формирование строки запроса
    {
        return this.baseUrl + url;
    }

    public get(url: string = '', header: HttpHeaders): Observable<any> //get запрос
    {
